...
#+begin_src emacs-lisp 
    (use-package org-ref
     :ensure t
     :config
     ;; Path to your .bib file exported from Zotero
     (setq org-ref-default-bibliography '("~/bibliography.bib")
           ;; Directory where ZotFile stores your PDFs in Google Drive, synced locally
           org-ref-pdf-directory "/Users/monibahmed/Library/CloudStorage/GoogleDrive-compasserror@gmail.com/My Drive/Resources"
           org-ref-bibliography-notes "/path/to/your/org/notes/bibnotes.org"))
     (use-package citar
       :ensure t
       :config
       (setq citar-bibliography '("~/bibliography.bib")
             citar-library-paths '("/Users/monibahmed/Library/CloudStorage/GoogleDrive-compasserror@gmail.com/My Drive/Resources")
             citar-notes-paths '("~/org/roam"))
       ;; Optional: Configure citar to open PDFs with Emacs or another viewer
       ;; (setq citar-file-open-function #'your-preferred-open-function)
       )
     ...
     (use-package org-roam-bibtex
       ...
       :ensure t
       :config
       (require 'citar) ; Ensure citar is loaded for compatibility
       (org-roam-bibtex-mode)
       (setq orb-roam-ref-format 'citar))
#+end_src
...
#+end_src
** Evil Bindings for different modes
#+begin_src emacs-lisp 
