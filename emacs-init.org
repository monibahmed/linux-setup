...
#+begin_src emacs-lisp 
  ...
  (use-package general
    ...
    (rune/leader-keys
      ...
      ;; Org Mode Bindings
      "ot" '(org-capture :which-key "Org Todo")
      "oa" '(org-agenda  :which-key "Org Agenda")
      "orr" '(citar-create-note :which-key "Org Roam Reference Note")
      ))
...
#+begin_src emacs-lisp 
    ...
    (defun my/refresh-org-keywords ()
      (save-excursion
        (goto-char (point-min))
        (when (re-search-forward "^#\\+SEQ_TODO:" nil t)
          (org-ctrl-c-ctrl-c))))

    (add-hook 'org-mode-hook #'my/refresh-org-keywords)
    ...
    (org-roam-capture-templates
     '(("d" "default" plain
       ...
       ("r" "reference note" plain
        ...
        :if-new
        (file+head "%(expand-file-name \"${slug}.org\" \"~/org/roam/reference/\")" 
                   "")
        :unnarrowed t)
