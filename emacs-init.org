...
#+begin_src emacs-lisp 
  ...
  (use-package general
    ...
    (rune/leader-keys
      ...
      "gt" '(lambda() (interactive)(find-file (concat google-drive "/org/gtd.org")):which-key "gtd.org")
      "ok" '(lambda() (interactive)(find-file (concat google-drive "/org/okr.org")):which-key "okr.org")
...
#+begin_src emacs-lisp 
    (use-package citar
      ...
      (org-cite-global-bibliography (list (concat google-drive "bibliography.bib")))
...
#+begin_src emacs-lisp 
  (use-package org 
    ...
    (setq org-capture-templates
          `(("t" "Todo" entry (file+headline ,(concat google-drive "org/gtd.org") "Capture Tasks")
             "* TODO %?\n")))
    (setq org-directory (concat google-drive "/org"))
    (setq org-default-notes-file (concat google-drive "/org/gtd.org"))
    (setq org-agenda-custom-commands
          '(("d" "Drafts" tags "DRAFT={TRUE}"
             ((org-agenda-overriding-header "Drafts")
              (org-agenda-prefix-format '((tags . "%-2t ")))))))
    (setq org-agenda-files (directory-files-recursively (concat google-drive "/org") "\\.org$"))
...
#+BEGIN_SRC emacs-lisp 
  (use-package org-roam
    :custom
    (org-roam-directory (file-truename (concat google-drive "/org/roam")))
    ...
    (org-roam-capture-templates
     '(("d" "default" plain
       ...
       ("r" "reference note" plain
        (file "~/org/roam/templates/ReferenceNote.org") 
        :if-new
        (file+head "%(expand-file-name (or citar-org-roam-subdir \"\") org-roam-directory)/${citar-citekey}.org"
                   "")
        :unnarrowed t)
       ("p" "project note" plain
        (file "~/org/roam/templates/ProjectNote.org") 
        :if-new
        (file+head "%(expand-file-name \"${slug}.org\" \"~/org/roam/project/\")" 
                   "") 
        :unnarrowed t)))
