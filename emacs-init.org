...
#+begin_src emacs-lisp 
  ...
  ;; (defun my/citar-org-roam-create-note (keys-entries)
  ;;    "Create an Org-roam note for the selected reference from Citar."
  ;;    (interactive (list (citar-select-refs :rebuild-cache t)))
  ;;    (let* ((key (caar keys-entries))
  ;;           (entry (cdar keys-entries))
  ;;           (title (or (citar-get-value "title" entry) "No Title"))
  ;;           (citekey (concat "@bibliography:" key)))
  ;;      (org-roam-capture- :keys "r"
  ;;                         :node (org-roam-node-create :title title)
  ;;                         :info (list :citekey citekey)
  ;;                         :props '(:finalize find-file)
  ;; :templates        ;;  (setq citar-notes-functions #'my/citar-org-roam-create-note)
#+end_src
