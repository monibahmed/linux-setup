...
#+begin_src emacs-lisp 
  ...
  (defun my/org-roam-capture-project-note ()
    ...
    (interactive)
    (org-roam-capture[[id:CB94DCA8-C002-453B-9E6A-79C1BD277566][trying]] :keys "p"))
    ...
    (setq org-capture-templates
          '(
            ...
            ("m" "Meeting" entry (file+headline "~/org/meetings.org" "Meetings")
             (function (lambda () (yas-expand-snippet (yas-lookup-snippet "meeting" 'org-mode))))))
          )
...
#+begin_src emacs-lisp 
  ...
  (with-eval-after-load 'org-roam
    (cl-defmethod org-roam-node-type ((node org-roam-node))
      "Return the first word of the file name of NODE, delimited by '_'."
      (let ((filename (file-name-nondirectory (org-roam-node-file node))))
        (car (split-string filename "_" t))))
