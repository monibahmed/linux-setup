...
#+begin_src emacs-lisp
   ;; Org-roam configuration
     (use-package org-roam
       ...
       ;; Optionally, bind a key to assign IDs to the current heading
       (define-key org-mode-map (kbd "C-c n a") 'org-id-get-create)

       ;; Optionally, bind a key to assign IDs to all headings in the current file
       (define-key org-mode-map (kbd "C-c n A") 'my/org-add-ids-to-headings-in-file)
...
** Org-Roam UI
:PROPERTIES:
:ID:       F1769EFA-A318-49F7-ADBB-C394F16DBA30
:END:
#+begin_src emacs-lisp
